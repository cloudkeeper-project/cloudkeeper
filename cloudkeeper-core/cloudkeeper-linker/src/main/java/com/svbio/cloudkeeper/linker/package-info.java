 ...
 *
 * <p>The interfaces that model the runtime state are defined in package {@link com.svbio.cloudkeeper.model.runtime}.
 * This package contains implementations, but only exposes them through the aforementioned interfaces. As required by
 * the contract of the {@link com.svbio.cloudkeeper.model.runtime} interfaces, all implementations are immutable.
 * Implementations are not serializable, however. This is by design, as the bare state defined by the package
 * {@link com.svbio.cloudkeeper.model.bare} is sufficient to reconstruct CloudKeeper objects. If serialization is
 * needed, objects should be converted to one of the Java Bean-style classes of package
 * {@link com.svbio.cloudkeeper.model.beans}. On the receiving end, this linker may then be used again to reconstruct
