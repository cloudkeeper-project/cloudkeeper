 ...
 * CloudKeeper DSL.
 */
public class DSLExecutableProvider implements ExecutableProvider {
    private static final DSLExecutableProvider DEFAULT_INSTANCE = new DSLExecutableProvider(ModuleFactory.getDefault());

    private final ModuleFactory moduleFactory;

    public DSLExecutableProvider(ModuleFactory moduleFactory) {
     ...
     * {@link #DSLExecutableProvider(ModuleFactory)}, where {@link ModuleFactory#getDefault()} is is passed as argument.
     */
    public static DSLExecutableProvider getDefault() {
