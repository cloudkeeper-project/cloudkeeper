 ...
 *
 * <ul><li>
 *     Use the {@link com.svbio.cloudkeeper.model.api.staging.StagingAreaProvider} instance passed to
 ...
 * </li><li>
 *     Use a {@link com.svbio.cloudkeeper.model.api.executor.ModuleConnectorProvider} instance for creating the
 *     {@link com.svbio.cloudkeeper.model.api.executor.ExtendedModuleConnector} instance and pass it to
 *     {@link com.svbio.cloudkeeper.model.api.Executable#run(com.svbio.cloudkeeper.model.api.ModuleConnector)}.
 *     Afterward, use {@link com.svbio.cloudkeeper.model.api.executor.ExtendedModuleConnector#commit()} to write the
