 ...
 * {@link com.svbio.cloudkeeper.model.beans.element.MutableAnnotatedConstruct} instances from Java core reflection
 * objects.
 *
...
public interface AnnotationCopyOption extends CopyOption {
     ...
     * will be passed to
     * {@link com.svbio.cloudkeeper.model.beans.element.annotation.MutableAnnotation#fromAnnotation(Annotation, CopyOption...)},
     * and the result will be added to the {@link com.svbio.cloudkeeper.model.beans.element.MutableAnnotatedConstruct}.
     *
     * <p>Note that this method will be called on all annotations, included those annotated with
     * {@link com.svbio.cloudkeeper.model.ModelEquivalent}. The argument passed as {@code annotation} is always the
