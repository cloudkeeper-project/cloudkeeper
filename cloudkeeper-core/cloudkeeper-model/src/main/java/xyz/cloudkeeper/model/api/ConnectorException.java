...
/**
 * Signals that the {@link xyz.cloudkeeper.model.api.ModuleConnector} encountered an exception.
 *
 * This exception typically occurs when user-defined code calls CloudKeeper code (via the
 * {@link xyz.cloudkeeper.model.api.ModuleConnector}), meaning that this exception is typically not
