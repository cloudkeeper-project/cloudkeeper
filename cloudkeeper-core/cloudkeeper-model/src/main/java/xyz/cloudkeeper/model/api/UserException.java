 ...
 * because it called a {@link xyz.cloudkeeper.model.api.ModuleConnector} method that threw an exception, then the
 * cause chain could contain an {@link xyz.cloudkeeper.model.api.staging.StagingException}.
 */
