 ...
 * {@link Executable#run(xyz.cloudkeeper.model.api.ModuleConnector)}. An
 * executor takes care of all intermediate steps, which includes dispatching the simple-module representation to the
 * target machine, recreating the staging area, creating a {@link xyz.cloudkeeper.model.api.ModuleConnector}
